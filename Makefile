...
=======
#    Updated: 2022/10/26 13:21:00 by fleduc           ###   ########.fr        #
...
SRCS = src/minishell.c src/signal.c src/utils.c src/parsing.c src/built_in.c src/find_cmd.c src/cd_pwd.c src/exec.c src/exit.c src/export_utils.c src/echo.c src/check_pipe.c src/change_var.c src/split_args.c src/utils2.c src/inspector_steve.c src/split_args_utils.c src/remove_quotes.c pipex/check_if_pipes.c pipex/pipe_cmd.c
OBJS = $(SRCS:.c=.o)
